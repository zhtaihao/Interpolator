...
//        }
     ...
     * Instead it will return the n-th derivative divided by n! of that single point,
     ...
     * outputs the n-th derivative divided by n! instead if "one" point was entered n times
     */
     ...
     * @throws IllegalArgumentException thrown when a negative number
     *                                  or a number larger than the maximum amount of expected derivatives is entered.
     *                                  MAX_DERIVATIVES is around 5 which should be plenty tbh
     */
